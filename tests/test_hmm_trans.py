...
def test_hmm_trans_weights_exact_vals():
    ...
    assert_almost_equal(hmm_trans_weights[('NOUN',START_TAG)],-2.77506,places=3)
    assert_almost_equal(hmm_trans_weights[('VERB',START_TAG)],-2.79835,places=3)
    assert_almost_equal(hmm_trans_weights[('INTJ','DET')],-16.60569,places=3)
    assert_almost_equal(hmm_trans_weights[('NOUN','DET')],-0.52105,places=3)
